...
import { updateLowongan } from "@/app/admin/bkk/actions";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#c0c0c0]">Edit Lowongan</h1>
          <p className="text-sm text-[#666] mt-1">
            Edit lowongan: {lowongan.posisi} di {lowongan.perusahaan}
          </p>
        </div>
      </div>

      <div className="bg-[#141414] border border-[#262626] p-6 lg:p-8">
        <form action={updateLowongan.bind(null, lowongan.id)} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                name="perusahaan"
                required
                defaultValue={lowongan.perusahaan}
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                name="tipePekerjaan"
                required
                defaultValue={lowongan.tipePekerjaan}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                name="batasLamaran"
                required
                defaultValue={new Date(lowongan.batasLamaran).toISOString().split("T")[0]}
                className="w-full px-4 py-2.5 bg-[#0a0a0a] border border-[#262626] text-[#c0c0c0] text-sm focus:outline-none focus:border-[#c0c0c0]"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              required
              rows={4}
              defaultValue={lowongan.persyaratan}
